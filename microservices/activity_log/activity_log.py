...
if os.name == "nt":
    app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root@localhost:3306/activity_db'
else:
    app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root:root@localhost:3306/activity_db'
...
def create_log():
    ...
    input: {"log_info": "microservice_name"} OR
    input: {"log_info": "microservice_name_error"}
