import type { CodeResponse, CodeClientConfig } from "@/interfaces/oauth2";
import { type Ref } from "vue";
import type { MaybeRef } from "@/utils/types";
/**
 * On success with implicit flow
 */
export declare type ImplicitFlowSuccessResponse = Omit<CodeResponse, "error" | "error_description" | "error_uri">;
/**
 * On error with implicit flow
 */
export declare type ImplicitFlowErrorResponse = Pick<CodeResponse, "error" | "error_description" | "error_uri">;
/**
 ...
 */
export interface ImplicitFlowOptions extends Omit<CodeClientConfig, "client_id" | "scope" | "callback"> {
    /**
     * On success callback
     *
 ...
 */
export default function useCodeClient(options?: ImplicitFlowOptions): UseCodeClientReturn;
//# sourceMappingURL=useCodeClient.d.ts.map