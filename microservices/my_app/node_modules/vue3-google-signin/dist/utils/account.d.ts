 ...
 * @param {type} params
 */
export declare function idRevoke(hint: string, callback?: RevocationCallback): void;
/**
 ...
 */
export declare function decodeCredential(credential: string): DecodedGoogleUser;
