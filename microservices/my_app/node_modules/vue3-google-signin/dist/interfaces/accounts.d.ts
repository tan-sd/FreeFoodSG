 ...
 * UxMode for client
 */
export declare type UxMode = "popup" | "redirect";
/**
 * Context
 */
export declare type Context = "use" | "signin" | "signup";
/**
 * Select By
 *
 * @see https://developers.google.com/identity/gsi/web/reference/js-reference#select_by
 */
export declare type SelectBy = "auto" | "user" | "user_1tap" | "user_2tap" | "btn" | "btn_confirm" | "brn_add_session" | "btn_confirm_add_session" | "auto" | "user" | "user_1tap" | "user_2tap" | "btn" | "btn_confirm" | "brn_add_session" | "btn_confirm_add_session";
/**
...
export declare type MomentListener = (promptMomentNotification: PromptMomentNotification) => void;
...
export declare type RevocationCallback = (response: RevocationResponse) => void;
